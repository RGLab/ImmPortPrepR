...
Next, we need to create the 10 dataframes that will be put together to form the larger txt:

1. study
2. study_categorization
3. arm_or_cohort
4. inclusion_exclusion
5. planned_visit
6. study_2_protocol
7. study_file
8. study_link
...
We will use `planned_visit$Name` as an example to first check fir spelling errors using 
